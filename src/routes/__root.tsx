...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium full-grain leather wallets, belts, bags, jackets and match-ready sports gear. Rugged craftsmanship meets athletic performance." },
      { property: "og:title", content: "Hide & Field — Leather Goods & Sports Equipment" },
      { property: "og:description", content: "Premium full-grain leather and match-ready sports gear." },
